...
public abstract class TestMixin {
	...
	public boolean activate(WorldClient world, BlockPos pos, IBlockState state, EntityPlayerAbstract player, Hand hand, Facing facing, float hitX, float hitY, float hitZ) {
		if (world.isRemote) {
